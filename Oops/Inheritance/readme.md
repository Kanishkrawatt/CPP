...
| The composed object is often created when the containing object is created and destroyed . | The aggregate object can be shared between multiple objects and can exist even after the object that contains it is destroyed. |
